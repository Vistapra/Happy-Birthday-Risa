...
const screens = {
    ...
    greeting: {
        ...
        message: "Wishing you a day as beautiful and radiant as you are.",
    ...
    giftBox: {
        ...
        skipText: "Skip",
        boxImage: "https://cdn-icons-png.flaticon.com/512/4213/4213653.png"
    },
    giftReveal: {
...
const seed = () => {
    ...
    // Seed Screens
    const screenStmt = db.prepare('INSERT OR REPLACE INTO screens (slug, type, data) VALUES (?, ?, ?)');
    for (const [key, value] of Object.entries(screens)) {
        screenStmt.run(key, key, JSON.stringify(value));
        console.log(`Seeded screen: ${key}`);
    }
